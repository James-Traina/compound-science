...
description: >-
  Guide for programmatic macroeconomic and cross-national data acquisition using FRED and World Bank APIs. Use when the user needs to download, filter, or work with economic time series, government statistics, or cross-country panel data. Triggers on "FRED", "World Bank", "economic data", "time series data", "macro data", "panel data download", "GDP series", "unemployment rate", "fredapi", "wbdata", "vintage data", "real-time data", "ALFRED", "data download", "API key", "economic indicators", or "cross-country data".
---

# Data Acquisition: FRED and World Bank
...
## SCOPE
Use this skill when downloading, cleaning, or working with macroeconomic time series or cross-national panel data. The `data-detective` agent handles data quality diagnostics after the data is in hand.
