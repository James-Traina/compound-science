...
3. **Deduplicate and Cross-Reference**
   ...
   - Surface compound-catalog search results: if past solutions are relevant, tag findings as "Known Pattern — see docs/solutions/[path]"
...
2. **Generate Review Summary**
   ...
   **Branch:** [branch-name]
   ...
   - [any matches from compound-catalog search]
